...
import { WiseHashContractsClient } from '../contracts/clients/WiseHashContractsClient';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: WiseHashContractsClient;

describe('WiseHashContracts', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new WiseHashContractsClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
